 ...
 */
export function insertCanvas(fileDiff) {
    const container = fileDiff.querySelector("div:has(> table)");
    if (container === null) {
        throw new Error(`[EXT_ERROR] Could not find the container of the diff ${fileDiff.getAttribute("data-tagsearch-path")}`);
    }
