 ...
 */
export function getFileDiff(filePath, diffList = getAllFileDiffs()) {
 ...
 */
export function getDiffVisibleLines(fileDiff) {
 ...
 */
export function getDiffLine(lineList, lineNumber) {
 ...
 */
export function getLineIndex(lineList, lineNumber) {
